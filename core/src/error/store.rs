...
pub enum StoreError {
    ...
    ConnectionFailed { #[source] source: rusqlite::Error },
    #[error("failed to execute database migrations: {source}")]
    MigrationFailed { #[source] source: rusqlite::Error },
    #[error("failed to insert record into store: {source}")]
    InsertFailed { #[source] source: rusqlite::Error },
    #[error("failed to query record from data layer: {source}")]
    QueryFailed { #[source] source: rusqlite::Error },
